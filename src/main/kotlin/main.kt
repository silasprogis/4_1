...
fun main () {
    ...
    val message1 = Message(1,1, 2, "message1")
    val message2 = Message(2,2, 1, "message2")
    val message3 = Message(3,2, 1, "message3")
    val message4 = Message(4,1, 2, "message4")
    val message5 = Message(1,3, 2, "message5")
    val message6 = Message(1,2, 3, "message6")
    val message7 = Message(5,6, 5, "message7")
    val message8 = Message(2,5, 6, "message8")
    val message9 = Message(3,4, 2, "message9")
    val message10 = Message(4,2, 1, "message10")
    val message11 = Message(1,1, 2, "message11")
    val message12 = Message(1,3, 2, "message12")
...
/*    NoteService.add(note1)
    ...
    ChatService.add(message7)
    ChatService.add(message8)
    ChatService.add(message9)
    ChatService.add(message10)
    ChatService.add(message11)
    ChatService.add(message12)
